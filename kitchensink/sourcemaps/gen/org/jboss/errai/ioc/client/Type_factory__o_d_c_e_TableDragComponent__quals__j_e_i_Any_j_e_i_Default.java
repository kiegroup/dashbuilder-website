...
public class Type_factory__o_d_c_e_TableDragComponent__quals__j_e_i_Any_j_e_i_Default extends Factory<TableDragComponent> { public Type_factory__o_d_c_e_TableDragComponent__quals__j_e_i_Any_j_e_i_Default() {
    super(new FactoryHandleImpl(TableDragComponent.class, "Type_factory__o_d_c_e_TableDragComponent__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true));
    handle.setAssignableTypes(new Class[] { TableDragComponent.class, DisplayerDragComponent.class, Object.class, LayoutDragComponent.class, HasModalConfiguration.class, HasConfiguration.class });
  }

  public TableDragComponent createInstance(final ContextManager contextManager) {
    ...
    final TableDragComponent instance = new TableDragComponent(_beanManager_0, _viewer_1, _placeManager_2, _perspectiveCoordinator_3);
