...
public class Type_factory__o_u_c_w_p_i_ClosableSimpleWorkbenchPanelView__quals__j_e_i_Any_j_e_i_Default_j_i_Named extends Factory<ClosableSimpleWorkbenchPanelView> { public Type_factory__o_u_c_w_p_i_ClosableSimpleWorkbenchPanelView__quals__j_e_i_Any_j_e_i_Default_j_i_Named() {
    super(new FactoryHandleImpl(ClosableSimpleWorkbenchPanelView.class, "Type_factory__o_u_c_w_p_i_ClosableSimpleWorkbenchPanelView__quals__j_e_i_Any_j_e_i_Default_j_i_Named", Dependent.class, false, "ClosableSimpleWorkbenchPanelView", true));
    handle.setAssignableTypes(new Class[] { ClosableSimpleWorkbenchPanelView.class, AbstractSimpleWorkbenchPanelView.class, AbstractDockingWorkbenchPanelView.class, AbstractWorkbenchPanelView.class, ResizeComposite.class, Composite.class, Widget.class, UIObject.class, Object.class, HasVisibility.class, EventListener.class, HasAttachHandlers.class, HasHandlers.class, IsWidget.class, IsRenderable.class, RequiresResize.class, WorkbenchPanelView.class, UberView.class, HasPresenter.class, DockingWorkbenchPanelView.class });
    handle.setQualifiers(new Annotation[] { QualifierUtil.ANY_ANNOTATION, QualifierUtil.DEFAULT_ANNOTATION, QualifierUtil.createNamed("ClosableSimpleWorkbenchPanelView") });
  }

  public ClosableSimpleWorkbenchPanelView createInstance(final ContextManager contextManager) {
    final ClosableSimpleWorkbenchPanelView instance = new ClosableSimpleWorkbenchPanelView();
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((ClosableSimpleWorkbenchPanelView) instance, contextManager);
  }

  public void destroyInstanceHelper(final ClosableSimpleWorkbenchPanelView instance, final ContextManager contextManager) {
    AbstractDockingWorkbenchPanelView_tearDownDockingPanel(instance);
  }

  public void invokePostConstructs(final ClosableSimpleWorkbenchPanelView instance) {
