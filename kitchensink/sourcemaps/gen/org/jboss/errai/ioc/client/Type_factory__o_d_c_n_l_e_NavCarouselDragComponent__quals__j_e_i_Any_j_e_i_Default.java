...
public class Type_factory__o_d_c_n_l_e_NavCarouselDragComponent__quals__j_e_i_Any_j_e_i_Default extends Factory<NavCarouselDragComponent> { public Type_factory__o_d_c_n_l_e_NavCarouselDragComponent__quals__j_e_i_Any_j_e_i_Default() {
    ...
    handle.setAssignableTypes(new Class[] { NavCarouselDragComponent.class, AbstractNavDragComponent.class, Object.class, NavDragComponent.class, PerspectiveEditorNavComponent.class, LayoutDragComponent.class, HasModalConfiguration.class, HasConfiguration.class });
  }
