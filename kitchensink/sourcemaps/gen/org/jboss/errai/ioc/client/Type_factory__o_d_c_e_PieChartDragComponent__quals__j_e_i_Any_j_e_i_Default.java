...
public class Type_factory__o_d_c_e_PieChartDragComponent__quals__j_e_i_Any_j_e_i_Default extends Factory<PieChartDragComponent> { public Type_factory__o_d_c_e_PieChartDragComponent__quals__j_e_i_Any_j_e_i_Default() {
    super(new FactoryHandleImpl(PieChartDragComponent.class, "Type_factory__o_d_c_e_PieChartDragComponent__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true));
    handle.setAssignableTypes(new Class[] { PieChartDragComponent.class, DisplayerDragComponent.class, Object.class, LayoutDragComponent.class, HasModalConfiguration.class, HasConfiguration.class });
  }

  public PieChartDragComponent createInstance(final ContextManager contextManager) {
    ...
    final PieChartDragComponent instance = new PieChartDragComponent(_beanManager_0, _viewer_1, _placeManager_2, _perspectiveCoordinator_3);
