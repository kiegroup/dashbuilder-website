...
public class Type_factory__o_d_c_e_MapChartDragComponent__quals__j_e_i_Any_j_e_i_Default extends Factory<MapChartDragComponent> { public Type_factory__o_d_c_e_MapChartDragComponent__quals__j_e_i_Any_j_e_i_Default() {
    super(new FactoryHandleImpl(MapChartDragComponent.class, "Type_factory__o_d_c_e_MapChartDragComponent__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true));
    handle.setAssignableTypes(new Class[] { MapChartDragComponent.class, DisplayerDragComponent.class, Object.class, LayoutDragComponent.class, HasModalConfiguration.class, HasConfiguration.class });
  }
  ...
  public MapChartDragComponent createInstance(final ContextManager contextManager) {
    ...
    final MapChartDragComponent instance = new MapChartDragComponent(_beanManager_0, _viewer_1, _placeManager_2, _perspectiveCoordinator_3);
