...
public class Type_factory__o_d_c_n_l_e_NavTilesDragComponent__quals__j_e_i_Any_j_e_i_Default extends Factory<NavTilesDragComponent> { public Type_factory__o_d_c_n_l_e_NavTilesDragComponent__quals__j_e_i_Any_j_e_i_Default() {
    super(new FactoryHandleImpl(NavTilesDragComponent.class, "Type_factory__o_d_c_n_l_e_NavTilesDragComponent__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true));
    handle.setAssignableTypes(new Class[] { NavTilesDragComponent.class, AbstractNavDragComponent.class, Object.class, NavDragComponent.class, PerspectiveEditorNavComponent.class, LayoutDragComponent.class, HasModalConfiguration.class, HasConfiguration.class });
  }
  ...
  public NavTilesDragComponent createInstance(final ContextManager contextManager) {
    ...
    final NavTilesWidget _navWidget_3 = (NavTilesWidget) contextManager.getInstance("Type_factory__o_d_c_n_w_NavTilesWidget__quals__j_e_i_Any_j_e_i_Default");
    ...
    final NavTilesDragComponent instance = new NavTilesDragComponent(_navigationManager_0, _pluginManager_1, _navComponentConfigModal_2, _navWidget_3);
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((NavTilesDragComponent) instance, contextManager);
  }

  public void destroyInstanceHelper(final NavTilesDragComponent instance, final ContextManager contextManager) {
