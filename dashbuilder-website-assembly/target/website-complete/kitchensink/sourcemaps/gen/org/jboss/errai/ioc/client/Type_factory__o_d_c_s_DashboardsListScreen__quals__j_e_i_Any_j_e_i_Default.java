...
public class Type_factory__o_d_c_s_DashboardsListScreen__quals__j_e_i_Any_j_e_i_Default extends Factory<DashboardsListScreen> { private class Type_factory__o_d_c_s_DashboardsListScreen__quals__j_e_i_Any_j_e_i_DefaultProxyImpl extends DashboardsListScreen implements Proxy<DashboardsListScreen> {
  ...
  native static RuntimeClientLoader DashboardsListScreen_RuntimeClientLoader_clientLoader(DashboardsListScreen instance) /*-{
    return instance.@org.dashbuilder.client.screens.DashboardsListScreen::clientLoader;
  }-*/;

  native static void DashboardsListScreen_RuntimeClientLoader_clientLoader(DashboardsListScreen instance, RuntimeClientLoader value) /*-{
    instance.@org.dashbuilder.client.screens.DashboardsListScreen::clientLoader = value;
  }-*/;
