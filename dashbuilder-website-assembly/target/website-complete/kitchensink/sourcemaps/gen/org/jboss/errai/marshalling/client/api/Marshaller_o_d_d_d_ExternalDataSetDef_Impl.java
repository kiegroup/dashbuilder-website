...
public class Marshaller_o_d_d_d_ExternalDataSetDef_Impl implements GeneratedMarshaller<ExternalDataSetDef> {
  ...
  native static boolean ExternalDataSetDef_boolean_accumulate(ExternalDataSetDef instance) /*-{
    return instance.@org.dashbuilder.dataset.def.ExternalDataSetDef::accumulate;
  }-*/;

  native static void ExternalDataSetDef_boolean_accumulate(ExternalDataSetDef instance, boolean value) /*-{
    instance.@org.dashbuilder.dataset.def.ExternalDataSetDef::accumulate = value;
  }-*/;
