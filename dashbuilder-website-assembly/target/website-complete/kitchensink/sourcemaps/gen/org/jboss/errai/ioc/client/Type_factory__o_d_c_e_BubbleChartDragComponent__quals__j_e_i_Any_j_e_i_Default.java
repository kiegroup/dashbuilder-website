...
public class Type_factory__o_d_c_e_BubbleChartDragComponent__quals__j_e_i_Any_j_e_i_Default extends Factory<BubbleChartDragComponent> { public Type_factory__o_d_c_e_BubbleChartDragComponent__quals__j_e_i_Any_j_e_i_Default() {
    super(new FactoryHandleImpl(BubbleChartDragComponent.class, "Type_factory__o_d_c_e_BubbleChartDragComponent__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true));
    handle.setAssignableTypes(new Class[] { BubbleChartDragComponent.class, DisplayerDragComponent.class, Object.class, LayoutDragComponent.class, HasModalConfiguration.class, HasConfiguration.class });
  }

  public BubbleChartDragComponent createInstance(final ContextManager contextManager) {
    ...
    final BubbleChartDragComponent instance = new BubbleChartDragComponent(_beanManager_0, _viewer_1, _placeManager_2, _perspectiveCoordinator_3);
