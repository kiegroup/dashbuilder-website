...
public class Type_factory__o_d_c_e_SelectorDragComponent__quals__j_e_i_Any_j_e_i_Default extends Factory<SelectorDragComponent> { public Type_factory__o_d_c_e_SelectorDragComponent__quals__j_e_i_Any_j_e_i_Default() {
    super(new FactoryHandleImpl(SelectorDragComponent.class, "Type_factory__o_d_c_e_SelectorDragComponent__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true));
    handle.setAssignableTypes(new Class[] { SelectorDragComponent.class, DisplayerDragComponent.class, Object.class, LayoutDragComponent.class, HasModalConfiguration.class, HasConfiguration.class });
  }

  public SelectorDragComponent createInstance(final ContextManager contextManager) {
    ...
    final SelectorDragComponent instance = new SelectorDragComponent(_beanManager_0, _viewer_1, _placeManager_2, _perspectiveCoordinator_3);
