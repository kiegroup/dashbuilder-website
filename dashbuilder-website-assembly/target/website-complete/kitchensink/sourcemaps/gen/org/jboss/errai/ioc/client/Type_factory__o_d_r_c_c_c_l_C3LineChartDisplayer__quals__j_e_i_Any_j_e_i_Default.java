...
import org.dashbuilder.renderer.c3.client.charts.line.C3LineChartDisplayer.View;
...
public class Type_factory__o_d_r_c_c_c_l_C3LineChartDisplayer__quals__j_e_i_Any_j_e_i_Default extends Factory<C3LineChartDisplayer> { public Type_factory__o_d_r_c_c_c_l_C3LineChartDisplayer__quals__j_e_i_Any_j_e_i_Default() {
    super(new FactoryHandleImpl(C3LineChartDisplayer.class, "Type_factory__o_d_r_c_c_c_l_C3LineChartDisplayer__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true));
    handle.setAssignableTypes(new Class[] { C3LineChartDisplayer.class, C3XYDisplayer.class, C3Displayer.class, C3AbstractDisplayer.class, AbstractGwtDisplayer.class, AbstractDisplayer.class, Object.class, Displayer.class, DisplayerListener.class, IsWidget.class });
  }
