...
public class Type_factory__o_d_c_w_v_DashboardCardView__quals__j_e_i_Any_j_e_i_Default_o_d_c_w_v_DashboardCardViewTemplateResource_default_InlineClientBundleGenerator implements org.jboss.errai.ioc.client.Type_factory__o_d_c_w_v_DashboardCardView__quals__j_e_i_Any_j_e_i_Default.o_d_c_w_v_DashboardCardViewTemplateResource {
  ...
  private void getStyleInitializer() {
    getStyle = new com.google.gwt.resources.client.CssResource() {
      ...
      public String getText() {
        return (".dashboardCardTitle{text-overflow:" + ("ellipsis")  + ";white-space:" + ("nowrap")  + ";overflow:" + ("hidden")  + ";font-size:" + ("15px")  + " !important;font-weight:" + ("350")  + " !important;height:" + ("20px")  + ";}.dashboardCardTitle:hover{text-overflow:" + ("unset")  + ";white-space:" + ("normal")  + ";overflow:" + ("visible")  + ";font-weight:" + ("450")  + " !important;z-index:") + (("999")  + ";}");
      }
    }
    ;
  }
  ...
  private native ResourcePrototype getResourceNative(String name) /*-{
    switch (name) {
      ...
      case 'getStyle': return this.@org.jboss.errai.ioc.client.Type_factory__o_d_c_w_v_DashboardCardView__quals__j_e_i_Any_j_e_i_Default.o_d_c_w_v_DashboardCardViewTemplateResource::getStyle()();
    }
    return null;
  }-*/;
}
