...
public class Type_factory__o_u_c_w_PanelManagerImpl__quals__j_e_i_Any_j_e_i_Default extends Factory<PanelManagerImpl> { private class Type_factory__o_u_c_w_PanelManagerImpl__quals__j_e_i_Any_j_e_i_DefaultProxyImpl extends PanelManagerImpl implements Proxy<PanelManagerImpl> {
    ...
    @Override public void addWorkbenchPart(PlaceRequest place, PartDefinition partDef, PanelDefinition panelDef, UIPart uiPart, String contextId, Integer preferredWidth, Integer preferredHeight) {
      if (proxyHelper != null) {
        final PanelManagerImpl proxiedInstance = proxyHelper.getInstance(this);
        proxiedInstance.addWorkbenchPart(place, partDef, panelDef, uiPart, contextId, preferredWidth, preferredHeight);
      } else {
        super.addWorkbenchPart(place, partDef, panelDef, uiPart, contextId, preferredWidth, preferredHeight);
      }
    }
