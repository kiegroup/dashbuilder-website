...
public class Type_factory__o_d_c_e_BarChartDragComponent__quals__j_e_i_Any_j_e_i_Default extends Factory<BarChartDragComponent> { public Type_factory__o_d_c_e_BarChartDragComponent__quals__j_e_i_Any_j_e_i_Default() {
    super(new FactoryHandleImpl(BarChartDragComponent.class, "Type_factory__o_d_c_e_BarChartDragComponent__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true));
    handle.setAssignableTypes(new Class[] { BarChartDragComponent.class, DisplayerDragComponent.class, Object.class, LayoutDragComponent.class, HasModalConfiguration.class, HasConfiguration.class });
  }

  public BarChartDragComponent createInstance(final ContextManager contextManager) {
    ...
    final BarChartDragComponent instance = new BarChartDragComponent(_beanManager_0, _viewer_1, _placeManager_2, _perspectiveCoordinator_3);
