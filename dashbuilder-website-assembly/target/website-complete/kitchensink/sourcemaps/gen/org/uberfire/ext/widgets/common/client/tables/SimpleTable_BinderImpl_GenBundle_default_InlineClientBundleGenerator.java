  ...
  private void styleInitializer() {
    style = new org.uberfire.ext.widgets.common.client.tables.SimpleTable_BinderImpl_GenCss_style() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".GJIO14PDDO{padding-top:" + ("10px")  + ";padding-bottom:" + ("10px")  + ";}.GJIO14PDEO{height:" + ("32px")  + ";}.GJIO14PDFO{float:" + ("left")  + ";text-align:" + ("left")  + ";}.GJIO14PDCO{text-align:" + ("center")  + ";}")) : ((".GJIO14PDDO{padding-top:" + ("10px")  + ";padding-bottom:" + ("10px")  + ";}.GJIO14PDEO{height:" + ("32px")  + ";}.GJIO14PDFO{float:" + ("right")  + ";text-align:" + ("right")  + ";}.GJIO14PDCO{text-align:" + ("center")  + ";}"));
      }
