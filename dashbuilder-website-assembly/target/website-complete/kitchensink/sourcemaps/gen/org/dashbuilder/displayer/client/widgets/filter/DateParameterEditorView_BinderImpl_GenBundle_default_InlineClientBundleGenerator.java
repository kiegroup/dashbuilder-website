  ...
  private void styleInitializer() {
    style = new org.dashbuilder.displayer.client.widgets.filter.DateParameterEditorView_BinderImpl_GenCss_style() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".GJIO14PDJN{float:" + ("right")  + ";width:" + ("275px")  + ";}.GJIO14PDIN{margin-right:" + ("-1px")  + ";}")) : ((".GJIO14PDJN{float:" + ("left")  + ";width:" + ("275px")  + ";}.GJIO14PDIN{margin-left:" + ("-1px")  + ";}"));
      }
